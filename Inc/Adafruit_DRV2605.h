...
#define DRV2605_REG_LRARESON 0x22
  ...
  void Adafruit_DRV2605(void);
  uint8_t Adafruit_DRV2605_begin(void);  
  ...
  void Adafruit_DRV2605_useERM(void);
  void Adafruit_DRV2605_useLRA(void);
